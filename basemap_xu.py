...
## Modified by huanxin
## This package combine Jsp,google map api with python. User can create a plot on google map with it.
## you could see how to use it at the end of this package
...
class maps:
	...
	def addpoint(self, lat, lng, color = '#FF0000',title = 'not default'):
...
if __name__ == "__main__":
	...
	#========================================================================================
	mymap = basemap_xu(37.428, -122.145, 16)
